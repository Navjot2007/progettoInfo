...
<form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
    <table>
        ...
        <tr>
            <td>Password</td>
            <td><input type="password" name="psw" id="myInput">
...
$host = 'localhost'; $db = 'community'; $user = 'community'; $pass = 'community'; $charset = 'utf8mb4';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['registrazione'])) {
    ...
    if (lunghezza($password)) { echo "La password deve essere più lunga di 7 caratteri.

"; $errore_password = true; }

   else if (contiamo($password)) { echo "Inserisci almeno un numero nella password.

"; $errore_password = true; }

    else if (primaMaiuscola($password)) { echo "Inserisci almeno una maiuscola.

"; $errore_password = true; }

    else if (metaCaratteri($password)) { echo "Inserisci almeno un carattere speciale.
